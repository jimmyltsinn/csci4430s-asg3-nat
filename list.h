 ...
 * 
 * This header file is adapted from Linux kernel
 *      [source tree]/include/linux/list.h
 * with modifications of removing singly linked list implementation 
 * and adopting for user space program by ourselves.  
 *
 *                                                          Jimmy Sinn
 *                                                           21/3/2012
 */
